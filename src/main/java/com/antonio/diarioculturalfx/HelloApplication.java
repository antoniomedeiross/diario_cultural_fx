...
public class HelloApplication extends Application {
    ...
    private void carregarScenes() throws IOException {
        ...
        FXMLLoader cadastroLoader = new FXMLLoader(HelloApplication.class.getResource("/com/antonio/diarioculturalfx/view/menus_cadastro/cadastro.fxml"));
        cadastroScene = new Scene(cadastroLoader.load(), 1280, 720);

        FXMLLoader cadastroLivroLoader = new FXMLLoader(HelloApplication.class.getResource("/com/antonio/diarioculturalfx/view/menus_cadastro/cadastro-livro.fxml"));
        cadastroLivroScene = new Scene(cadastroLivroLoader.load(), 1280, 720);

        FXMLLoader cadastroFilmeLoader = new FXMLLoader(HelloApplication.class.getResource("/com/antonio/diarioculturalfx/view/menus_cadastro/cadastro-filme.fxml"));
        cadastroFilmeScene = new Scene(cadastroFilmeLoader.load(), 1280, 720);

        FXMLLoader cadastroSerieLoader = new FXMLLoader(HelloApplication.class.getResource("/com/antonio/diarioculturalfx/view/menus_cadastro/cadastro-serie.fxml"));
    ...
    public static void trocarScene(String click) {
        ...
        switch (click){
            ...
            case "Cadastro":
                ...
                stageTroca.getIcons().add(new Image(Objects.requireNonNull(HelloApplication.class.getResourceAsStream("/com/antonio/diarioculturalfx/icons/cadastro.png"))));
